...
import { BsChatLeftText,BsUiChecksGrid,BsPencilSquare,BsPeople,BsFilePerson,BsHammer,BsBook,BsChatDots,BsFillCameraReelsFill } from "react-icons/bs";
   ...
   return (
     ...
     <div className={classes.SideMainContainer} style={{width:sideNavBarWidth}} >
	   ...
	   buttonColor={{background:dashboardButtonColor }}/>
        ...
        <SideNavBarButton onPress={achievementsHandler} icon={BsFillCameraReelsFill} name="Meetings"  buttonColor={{background:achievementsButtonColor }} />

        <SideNavBarButton onPress={courseGradesHandler}  icon={BsReverseLayoutTextSidebarReverse} name="Grades" buttonColor={{background:courseButtonColor }}/>
